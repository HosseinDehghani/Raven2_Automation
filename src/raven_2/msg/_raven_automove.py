...
class raven_automove(roslib.message.Message):
  _md5sum = "73c44e0ecfc398ec9947294e8638390d"
...
"""
  __slots__ = ['hdr','del_pos','grasp','tf_incr']
  _slot_types = ['Header','int32[6]','int32[2]','geometry_msgs/Transform[2]']
