"""autogenerated by genmsg_py from raven_fk.msg. Do not edit."""
...
class raven_fk(roslib.message.Message):
  _md5sum = "cb562579f6ae3d04a58328e8bbece449"
  _type = "raven_2/raven_fk"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """Header      hdr
geometry_msgs/Transform[2] fk
...
"""
  __slots__ = ['hdr','fk']
  _slot_types = ['Header','geometry_msgs/Transform[2]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(raven_fk, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.hdr is None:
        self.hdr = std_msgs.msg._Header.Header()
      if self.fk is None:
        self.fk = [geometry_msgs.msg.Transform(),geometry_msgs.msg.Transform()]
    else:
      self.hdr = std_msgs.msg._Header.Header()
      self.fk = [geometry_msgs.msg.Transform(),geometry_msgs.msg.Transform()]
